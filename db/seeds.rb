...
bio: "Just a young girl dreaming of a happily ever after. be my prince charming make me beautiful doll me up", first_date_idea: "spoil me daddy buy me nice clothes and pick me up in a limo come on daddy you know you want to", my_anthem: "Cascada - Everytime We Touch is the greatest tune ever ahhhh",
hobbies: "DJ'ing, thotting on insta, making out with ur daddd, getting into trouble", my_aesthetic: "Smol Goth GF too cute to hate but annoying as all hell",
looking_for: "love" )

User.create(username: "test1", password: "password", screen_name: "big boi", city: "NY", img_url: "http://res.cloudinary.com/dyv6nxcqz/image/upload/v1523407051/20766775_110930696257299_1250066457887244288_n.jpg", pronouns: "he/him/his", age: 19,
...
User.create(username: "test2", password: "password", screen_name: "hey hun", city: "LA", img_url: "http://res.cloudinary.com/dyv6nxcqz/image/upload/v1523406815/prof-pic2.png", pronouns: "they/them", age: 35,
...
User.create(username: "test3", password: "password", screen_name: "need help", city: "DC", img_url: "http://res.cloudinary.com/dyv6nxcqz/image/upload/v1523406836/prof-pic1.png", pronouns: "she/her", age: 16,
...
User.create(username: "test4", password: "password", screen_name: "party queen", city: "Miami", img_url: "http://res.cloudinary.com/dyv6nxcqz/image/upload/v1523407065/20394099_242132076308120_7703107597238272000_n.jpg", pronouns: "she/her/princess", age: 27,
...
User.create(username: "test5", password: "password", screen_name: "bay girl", city: "Bay Area", img_url: "http://res.cloudinary.com/dyv6nxcqz/image/upload/v1523407037/21479703_2041816742707024_8159332853214085120_n.jpg", pronouns: "she/her/hers", age: 26,
...
User.create(username: "test6", password: "password", screen_name: "flower child", city: "NY", img_url: "http://res.cloudinary.com/dyv6nxcqz/image/upload/v1523407044/21224641_1968737290008046_3976370178215641088_n.jpg", pronouns: "they/them", age: 40,
...
User.create(username: "test7", password: "password", screen_name: "aspiring actor", city: "LA", img_url: "http://res.cloudinary.com/dyv6nxcqz/image/upload/v1523407119/13774346_312769012392564_339009418_n.jpg", pronouns: "she/her", age: 28,
...
User.create(username: "test8", password: "password", screen_name: "always learning", city: "DC", img_url: "http://res.cloudinary.com/dyv6nxcqz/image/upload/v1523400308/profpics/zy16kezi5ytjafid4mcb.png", pronouns: "him/they", age: 32,
...
User.create(username: "test9", password: "password", screen_name: "Looking", city: "Miami", img_url: "http://res.cloudinary.com/dyv6nxcqz/image/upload/v1523407028/26863671_157985988324351_1392497030940590080_n.jpg", pronouns: "she/him/they", age: 27,
